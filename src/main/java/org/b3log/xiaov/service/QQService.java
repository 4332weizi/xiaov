...
public class QQService {
	 ...
	 */
	private static final String XIAO_V_INTRO = "你好，我是小薇~";

	/**
	 * XiaoV listener self intro.
	 */
	private static final String XIAO_V_LISTENER_INTRO = "你好，我是小薇的守护~";
				...
				new Thread(new Runnable() {
					...
					public void run() {
						try {
							...
							LOGGER.log(Level.ERROR, "XiaoV on friend message error", e);
						}
					}
				}).start();
			}
	...
	private void sendMessageToFriend(long firendId, String msg) {
		xiaoV.sendMessageToFriend(firendId, msg);
	}

	private void sendMessageToGroup(long groupId, String msg) {
	...
	private void sendMessageToDiscuss(long discussId, String msg) {
	...
	public void onQQFriendMessage(Message message) {

		long friendId = message.getUserId();

		String content = message.getContent();
		String userName = xiaoV.getFriendInfo(friendId).getNick();

		String msg = answerFromRobot(content, userName);

		if (StringUtils.isBlank(msg)) {
			return;
		}

		sendMessageToFriend(friendId, msg);
	}
	...
	public void onQQDiscussMessage(DiscussMessage message) {
	...
	private String answer(String content, String userName) {
		String keyword = "";
		...
		if (StringUtils.isNotBlank(keyword)) {
			...
			ret = answerFromRobot(content, userName);
		}

		return ret;
	}

	private String answerFromRobot(String content, String userName) {
		String ret = "";
		if (1 == QQ_BOT_TYPE) {
